	...
	return (
		<div className='bg-white rounded-lg shadow p-4 flex items-center justify-between transition-all hover:shadow-md'>
			<div className='flex items-center gap-4'>
				<Link to={`/profile/${request.sender.rollnumber}`}>
					<img
						src={request.sender.profileImg || "/avatar.png"}
						alt={request.name}
				...
				<div>
					<Link to={`/profile/${request.sender.rollnumber}`} className='font-semibold text-lg'>
						{request.sender.name}
					</Link>
