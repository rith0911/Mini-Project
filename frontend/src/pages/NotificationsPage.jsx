	...
	const renderNotificationContent = (notification) => {
		switch (notification.type) {
			...
			case "comment":
				return (
					<span>
						<Link to={`/profile/${notification.relatedUser.rollnumber}`} className='font-bold'>
								...
								>
									<div className='flex items-start justify-between'>
										<div className='flex items-center space-x-4'>
											<Link to={`/profile/${notification.relatedUser.rollnumber}`}>
												<img
													src={notification.relatedUser.profileImg || "/avatar.png"}
